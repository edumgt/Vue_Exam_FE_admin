  ...
  <div class="app-container">
    <el-form :model="form" ref="form" label-width="100px" v-loading="formLoading">
      <el-form-item label="학년：">
        <el-select v-model="form.gradeLevel" placeholder="학년">
      ...
      <el-form-item label="점수：" required>
        <el-input v-model="form.score" placeholder="점수"  />
      </el-form-item>
      <el-form-item label="난이도：" required>
        <el-rate v-model="form.difficult" class="question-item-rate"></el-rate>
      </el-form-item>
      <el-form-item label="정답지문：" required>
      ...
      <el-form-item>
        ...
        <el-button type="success" @click="questionItemAdd">추가보기</el-button>
    ...
    <el-dialog  :visible.sync="richEditor.dialogVisible"  append-to-body :close-on-click-modal="false" style="width: 100%;height: 100%"   :show-close="false" center>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="editorConfirm">저장</el-button>
        <el-button @click="richEditor.dialogVisible = false">취소</el-button>
      </span>
    </el-dialog>
