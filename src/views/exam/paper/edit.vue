  ...
  <div class="app-container">
    <el-form :model="form" ref="form" label-width="100px" v-loading="formLoading">
      <el-form-item label="학년：" required>
        <el-select v-model="form.level" placeholder="학년">
      ...
      <el-form-item label="시험종류：" required>
        <el-select v-model="form.paperType" placeholder="시험종류" >
      ...
      <el-form-item label="시험지명：" required>
        <el-input v-model="form.name" />
      </el-form-item>
      <el-form-item :key="index" :label="'제목'+(index+1)+'：'" required v-for="(titleItem,index) in form.titleItems">
