<template>
  <div class="app-container">
    <div class="row items-center q-mb-md">
      ...
      <q-btn unelevated color="primary" label="추가" class="q-ml-sm" :to="{path:'/user/teacher/edit'}" />
    </div>
    <q-table
      :rows="tableData"
      :columns="columns"
    ...
    >
      ...
      <template v-slot:body-cell-actions="{row}">
        <q-td class="text-center">
          <q-btn size="sm" flat @click="$router.push({path:'/user/teacher/edit', query:{id:row.id}})">수정</q-btn>
...
export default {
  ...
  data () {
    return {
      queryParam: { userName: '', role: 2, pageIndex: 1, pageSize: 10 },
      listLoading: true,
      tableData: [],
      total: 0,
